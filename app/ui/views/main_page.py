...
class MainPageView:
    ...
    def render(self) -> None:
        ...
        main_page_html = (
            ...
            '<div class="main-title">Página principal</div>'
            '<div class="main-text">Centro de acceso rápido a mapas, hospitales, inventario y reporting.</div>'
            ...
            '<div class="mainpage-card-title">KPI Mapa Interactivo</div>'
            '</div>'
            ...
            '<div class="mainpage-card-title">Hospitales</div>'
            '</div>'
            ...
            '<div class="mainpage-card-top">'
            '<div>'
            '<div class="mainpage-card-kicker">Logística</div>'
            '<div class="mainpage-card-title">Inventario</div>'
            '</div>'
            '<div class="mainpage-card-icon">📦</div>'
            '</div>'
            ...
            '<div class="mainpage-card-top">'
            '<div>'
            '<div class="mainpage-card-kicker">Analítica</div>'
            '<div class="mainpage-card-title">Reportes/Estadísticas</div>'
            '</div>'
            '<div class="mainpage-card-icon">📈</div>'
            '</div>'
