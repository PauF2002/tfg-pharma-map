...
class SidebarNavigation:
    ...
    def _open_sidebar_html(self) -> str:
        ...
        return (
            ...
            '</a>'
            '<div class="nav-group">'
            f'{self.nav_item("Página principal", "⌂", "main_page")}'
            f'{self.nav_item("Estado del mercado", "▦", "market_state")}'
            f'{self.nav_item("Noticias", "📰", "news")}'
            f'{self.nav_item("Configuración", "⚙", "settings")}'
            '</div>'
            '</div>'
            '<div class="bottom-group">'
            f'{self.nav_item("Cerrar sesión", "⇠", "logout")}'
            '</div>'
            '</div>'
        )
