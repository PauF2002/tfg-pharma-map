...
SMOKE = BASE / "data" / "processed" / "ccaa_smoking.csv"

OUT_PROFILE = BASE / "data" / "processed" / "ccaa_smoking_profile_latest.csv"
OUT_SCORE = BASE / "data" / "processed" / "ccaa_smoking_opportunity_score.csv"
OUT_MAP = BASE / "outputs" / "maps" / "ccaa_map_smoking.html"
...
smoke = s[["ccaa_key", "smoking_pct"]].copy()
...
fig.update_layout(
    title="Opportunity score for smoking by CCAA",
