...
SMOKE = BASE / "data" / "processed" / "ccaa_epilepsia.csv"

OUT_PROFILE = BASE / "data" / "processed" / "ccaa_epilepsia_profile_latest.csv"
OUT_SCORE = BASE / "data" / "processed" / "ccaa_epilepsia_opportunity_score.csv"
OUT_MAP = BASE / "outputs" / "maps" / "ccaa_map_epilepsia.html"
...
smoke = s[["ccaa_key", "epilepsia_val"]].copy()
...
fig.update_layout(
    title="Opportunity score for epilepsia by CCAA",
